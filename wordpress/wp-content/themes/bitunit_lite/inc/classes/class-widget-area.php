...
if ( ! class_exists( 'Bitunit_lite_Widget_Area' ) ) {

	class Bitunit_lite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'bitunit_lite_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'bitunit_lite_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'bitunit_lite_widget_area_classes', $classes, $area_id );
	...
	function bitunit_lite_widget_area() {
		return Bitunit_lite_Widget_Area::get_instance();
	}

	bitunit_lite_widget_area();
}
