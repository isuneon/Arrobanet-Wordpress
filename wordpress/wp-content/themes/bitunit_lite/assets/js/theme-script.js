(function($){
	...
	CherryJsCore.theme_script = {
		...
		smart_slider_init: function( self ) {
			$( '.bitunit_lite-smartslider' ).each( function() {
				var slider = $(this),
		...
		swiper_carousel_init: function ( self ) {
			...
			jQuery('.bitunit_lite-carousel').each( function() {
				var swiper = null,
		...
		subscribe_init: function( self ) {
			CherryJsCore.variable.$document.on( 'click', '.subscribe-block__submit', function( event ){
				...
				var $this       = $(this),
					...
					nonce      = form.find( 'input[name="bitunit_lite_subscribe"]' ).val(),
				...
				$.ajax({
					url: bitunit_lite.ajaxurl,
					type: 'post',
					dataType: 'json',
					data: {
						action: 'bitunit_lite_subscribe',
						mail: mail,
						nonce: nonce
					},
					error: function() {
		...
		main_menu: function ( self, target ) {
			...
			if ( 'undefined' !== typeof bitunit_lite &&
				 'undefined' !== typeof bitunit_lite.labels &&
				 'undefined' !== typeof bitunit_lite.labels[ 'hidden_menu_items_title' ] &&
				 '' !== bitunit_lite.labels.hidden_menu_items_title ) {
				 moreButtonText = bitunit_lite.labels.hidden_menu_items_title;
			}
		...
		to_top_init: function ( self ) {
			if ( $.isFunction( jQuery.fn.UItoTop ) ) {
				$().UItoTop({
					text: bitunit_lite.labels.totop_button,
					scrollSpeed: 600
				});
			}
		},
