	...
	<div class="post-list__item-content">
		<div class="post-list__item-content--inner">
			...
			<div class="entry-content">
				<?php $blog_content = get_theme_mod( 'blog_posts_content', bitunit_lite_theme()->customizer->get_default( 'blog_posts_content' ) );
				...
				<div class="entry-content--footer">
					<?php $utility->attributes->get_button( array(
						...
						'text'  => get_theme_mod( 'blog_read_more_text', bitunit_lite_theme()->customizer->get_default( 'blog_read_more_text' ) ),
			...
			<?php if ( 'post' === get_post_type() ) : ?>
				<div class="entry-meta">
					<span class="post__date">
						<?php $date_visible = bitunit_lite_is_meta_visible( 'blog_post_publish_date', 'loop' ) ? 'true' : 'false';
					...
					<span class="post__comments">
						<?php $comment_visible = bitunit_lite_is_meta_visible( 'blog_post_comments', 'loop' ) ? 'true' : 'false';
